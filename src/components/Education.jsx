            ...
            <tbody class="divide-y divide-gray-200 bg-white">
              <tr>
                  ...
                  <div class="flex items-center">
                    <div class="h-10 w-10 flex-shrink-0">
                      {/* <img
                        ...
                        alt=""
                      /> */}
                      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="grey" class="bi bi-mortarboard-fill" viewBox="0 0 16 16">
                ...
                <td class="whitespace-nowrap px-12 py-4">
                  <div class="text-m text-gray-900 ">Sharda University</div>
                  <div class="text-sm text-gray-700">Greater Noida, Uttar Pradesh</div>
                </td>
                <td class="whitespace-nowrap px-4 py-4">
                  <span class="inline-flex rounded-full bg-indigo-100 px-2 py-1 text-m font-semibold leading-5 text-green-800">
                    2022-2024
                  </span>
                </td>
              </tr>
              <tr>
                ...
                <td class="whitespace-nowrap px-12 py-4">
                  <div class="text-m text-gray-900 ">Guru Gobind Singh Indraprastha University</div>
              ...
              <tr>
                ...
                <td class="whitespace-nowrap px-12 py-4">
                  <div class="text-m text-gray-900 ">Jamia Millia Islamia</div>
                  <div class="text-sm text-gray-700">New Delhi, Delhi</div>
                </td>
                <td class="whitespace-nowrap px-4 py-4">
                  <span class="inline-flex rounded-full bg-indigo-100 px-2 py-1 text-m font-semibold leading-5 text-green-800">
