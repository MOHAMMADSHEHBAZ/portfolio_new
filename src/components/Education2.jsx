...
const Education2 = () => {
  return (
    ...
    <div className='my-5 md: flex items-center justify-center'>
    ...
    <li className="relative mb-6 sm:mb-0">
        ...
        <div className="mt-3 sm:pe-8">
            <h3 className="md:text-lg font-semibold text-gray-900 dark:text-white">Masters of Computer Application</h3>
    ...
    <li className="relative mb-6 sm:mb-0">
        ...
        <div className="mt-3 sm:pe-8">
            <h3 className="md:text-lg font-semibold text-gray-900 dark:text-white">Bachelor of Computer Application</h3>
    ...
    <li className="relative mb-6 sm:mb-0">
        ...
        <div className="mt-3 sm:pe-8">
            <h3 className="md:text-lg font-semibold text-gray-900 dark:text-white">Senior Secondary School</h3>
    ...
    <li className="relative mb-6 sm:mb-0">
        ...
        <div className="mt-3 sm:pe-8">
            <h3 className="md:text-lg font-semibold text-gray-900 dark:text-white">Secondary School </h3>
