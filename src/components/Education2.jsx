  ...
  return (
    ...
    <li className="relative mb-6 sm:mb-0">
        <div className="flex items-center">
            <div className="z-10 flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full ring-0 ring-white sm:ring-8 dark:ring-gray-900 shrink-0">
    ...
    <li className="relative mb-6 sm:mb-0">
        <div className="flex items-center">
            ...
            <div className="hidden sm:flex w-full md:flex bg-gray-200 h-0.5 dark:bg-gray-700"></div>
        </div>
        <div className="mt-3 sm:pe-8">
